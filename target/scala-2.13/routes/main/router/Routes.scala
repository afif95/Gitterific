...
class Routes(
  ...
  // @LINE:12
  private[this] lazy val controllers_ApiController_showRepos2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("home")))
  )
  private[this] lazy val controllers_ApiController_showRepos2_invoker = createInvoker(
  ...
  // @LINE:14
  private[this] lazy val controllers_ApiController_fetchRepos3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("home")))
  )
  private[this] lazy val controllers_ApiController_fetchRepos3_invoker = createInvoker(
  ...
  // @LINE:18
  private[this] lazy val controllers_HomeController_time6_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("time")))
  )
  private[this] lazy val controllers_HomeController_time6_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:12
    case controllers_ApiController_showRepos2_route(params@_) =>
      call { 
        controllers_ApiController_showRepos2_invoker.call(
          req => ApiController_0.showRepos(req))
      }
  
    // @LINE:14
    case controllers_ApiController_fetchRepos3_route(params@_) =>
      call { 
        controllers_ApiController_fetchRepos3_invoker.call(
    ...
    case controllers_HomeController_explore4_route(params@_) =>
      call { 
        controllers_HomeController_explore4_invoker.call(HomeController_2.explore)
      }
  
    // @LINE:17
    case controllers_HomeController_tutorial5_route(params@_) =>
      call { 
        controllers_HomeController_tutorial5_invoker.call(HomeController_2.tutorial)
      }
  
    // @LINE:18
    case controllers_HomeController_time6_route(params@_) =>
      call { 
        controllers_HomeController_time6_invoker.call(HomeController_2.time)
      }
