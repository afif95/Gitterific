...
public interface GitHubApi {
	...
	CompletionStage<JsonNode> fetchReposByTopic(Map<String, List<Repository>> userSearches, String searchVal, ActorRef ws, WSClient wsc, ActorRef ua, Session session, Singleton singleton);
	
	CompletionStage<JsonNode> fetchCommitImp(Map<String, List<Repository>> userSearches, String searchVal, ActorRef ws, WSClient wsc, ActorRef ua, Session session, Singleton singleton);
	
	CompletionStage<JsonNode> fetchIssueImp(Map<String, List<Repository>> userSearches, String searchVal, ActorRef ws, WSClient wsc, ActorRef ua, Session session, Singleton singleton);
